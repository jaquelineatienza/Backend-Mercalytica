...
2. **Client (FastAPI + MCP)**
   Gestión de solicitudes, procesamiento de datos y control del contexto conversacional.

3. **Server**
   Recolección, almacenamiento y análisis de datos del mercado (productos, precios, valoraciones, etc.).
